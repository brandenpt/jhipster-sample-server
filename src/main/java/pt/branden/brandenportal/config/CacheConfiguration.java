...
public class CacheConfiguration {
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream.of(pt.branden.brandenportal.repository.UserRepository.USERS_BY_LOGIN_CACHE, pt.branden.brandenportal.repository.UserRepository.USERS_BY_EMAIL_CACHE)
