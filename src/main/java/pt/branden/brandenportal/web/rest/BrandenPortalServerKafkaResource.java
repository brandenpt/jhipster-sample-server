...
@RestController
@RequestMapping("/api/branden-portal-server-kafka")
public class BrandenPortalServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BrandenPortalServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BrandenPortalServerKafkaResource(KafkaProperties kafkaProperties) {
