...
class BrandenportalserverKafkaResourceIT {
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/brandenportalserver-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/brandenportalserver-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
